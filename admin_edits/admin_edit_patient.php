...
<html lang="en">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
    <h1>    Update, Delete or View any Patient's record!</h1>
    <!--box code starts-->
    <div class="container">
    <form action="admin_edit_patient.php" method="POST">
  <div class="mb-3">
...
//<!--Post Method ends-->
 ...
 //printing values from the dict
    echo "<tr>
      ...
      <td>
      <button class='btn '><a href='admin_edit_patient_update.php?updateid=". $patientid."'>Update</a></button>
      <button class='btn '><a href='admin_edit_patient_delete.php?deleteid=". $patientid."'>Delete</a></button>
      </td>
      </tr>";
