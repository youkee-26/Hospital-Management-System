...
<html lang="en">
  <head>
    ...
    <title>Doctor Edit Report</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">
  </head>
  <body>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
    <h1>   Hello Doctor, View any Report!</h1>
    <!--box code starts-->
    <div class="container">
    <form action="doctor_edit_report.php" method="POST">
  <div class="mb-3">
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
   ...
   $sql="Select S.Serial,S.Date,S.Time,S.Description from services S, takes T where S.Serial = T.service_serial and T.p_id ='$patientid' and S.Serial like 'R%';";
   $result=mysqli_query($conn,$sql);
   #$result_row = mysqli_fetch_assoc($result);//forming a dict from the obtained tuple

    //<!--Post Method ends-->
    echo"<button class='btn '><a href='doctor_edit_report_insert.php?insertid=". $patientid."'>Insert a New Report</a></button>";
